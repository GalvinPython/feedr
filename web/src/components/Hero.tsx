...
// @ts-ignore
import dashboard from "../assets/images/feat_main.png";
            ...
            <div className="w-full md:w-[800px] xl:w-[900px] flex flex-col justify-center items-center pt-16 md:pt-16 lg:pt-20 text-center">
                ...
                >
                    <h3 className="text-secondaryColor text-sm sm:text-base  mb-6 sm:mt-32 mt-16  font-bold">
                        The fastest Discord social media notification bot
                    </h3>
                </motion.div>
                <motion.div
                    initial={{ opacity: 0, y: 10 }}
                ...
                >
                    <div className="text-5xl sm:text-6xl lg:text-7xl xl:text-7xl font-bold tracking-wide  text-primaryText  px-8 sm:px-8 md:px-20 lg:px-4">
                        <h1 className="inline md:hidden">Feedr</h1>
                        <h1 className="hidden md:inline">Feedr for Discord</h1>
                    </div>
                </motion.div>
                <motion.div
                    initial={{ opacity: 0, y: 10 }}
                ...
                >
                    <h2 className="text-secondaryText text-sm lg:text-base xl:text-lg sm:text-base mt-10 px-12 sm:px-48 ">
                        Notify your Discord server members about new posts on
                        your YouTube channel and Twitch streams!
                    </h2>
                </motion.div>
                <motion.div
                    initial={{ opacity: 0, y: 10 }}
                ...
                >
                    <div className="relative w-screen flex justify-center ">
                        <img
                            src={dashboard.src}
                            alt="Dashboard image"
                            className="w-4/5 xl:w-[700px] md:w-[600px] mx-auto absolute z-10 rounded-xl main-border-gray hero-dashboard-border-gradient"
                        />
                    </div>
                </motion.div>
                <div className="relative w-screen flex justify-center ">
